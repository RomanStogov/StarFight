...
public class ScreenGameArracis implements Screen {
    ...
    long timeEnemyLastSpawn, timeEnemySpawnInterval = 2000; // Возрождениие врагов
    long timeAsteroidLastSpawn, timeAsteroidSpawnInterval = 2800; // Возрождениие астероидов
    ...
    public ScreenGameArracis(MySF mySF) {
        sf = mySF;

        imgBackgrounds = new Texture("Stars2.png");
    ...
    public void render(float delta) {
        ...
        for(Enemy enemy: enemies)
            sf.batch.draw(imgEnemy[enemy.type], enemy.getX(), enemy.getY(), enemy.width, enemy.height);
