...
public class ScreenGamePolifem implements Screen {
    ...
    long timeEnemyLastSpawn, timeEnemySpawnInterval = 2200; // Возрождениие врагов
    long timeAsteroidLastSpawn, timeAsteroidSpawnInterval = 3000; // Возрождениие астероидов
    long timeShotLastSpawn, timeShotSpawnInterval = 550;  // Выстрелы лазерного оружия
    ...
    public ScreenGamePolifem(MySF mySF) {
        sf = mySF;
        imgBackgrounds = new Texture("Stars1.png");
